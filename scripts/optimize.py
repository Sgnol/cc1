...
parser.add_argument("--address", help="CryptoYuc address to optimize", required=True)
parser.add_argument("--port", type=int, help="Wallet port", required=False, default=9707)
